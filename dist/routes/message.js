...
messageRouter.post("/sendmessage", _validators.createMessage, function (req, res) {
...
messageRouter.get("/allreceivedmails", function (req, res) {
   res.status(200).send({
      status: 200,
...
messageRouter.get("/receivedmessages/:id", function (req, res) {
...
messageRouter.get("/sentemails/:id", function (req, res) {
   var id = req.params.id;
...
messageRouter.get("/unreadmails/:id", function (req, res) {
   var id = req.params.id;
...
messageRouter.delete("/email/:id", function (req, res) {
   var userMessageId = req.query.userMessageId;
   var id = req.params.id;
